...
func NewCreatePlaylistCmd(
	...
	cmd := &cobra.Command{
		...
		Long: `Create a Spotify playlist from a live setlist.

Fetches recent setlists for an artist and creates a Spotify playlist with the songs
performed at those shows.

Requires Spotify and setlist.fm API credentials.`,
